...
function App(props) {
    const renderButton = () => {
        if (props.inPlaylist) {
          return <input type = "submit" style={{color: 'white', backgroundColor: '#3081D0'}} value = "Remove from playlist"/>
        } else {
          return <input  type = "submit" style={{color: 'white', backgroundColor: '#3081D0'}} value = "Add to playlist"/>
        }
      }
